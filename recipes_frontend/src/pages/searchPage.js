...
function Search({ Option, setServerStatus }) {
  ...
  const getDataFromServer = () => {
    ...
    let params="?Cuisine="+cuisines+"&Course="+course+"&Diet="+diet+"&SearchText="+searchText;
  ...
  return (
    <div>
      <div>
        {Option &&
          Option.diet &&
          optionElement(Option.diet, diet, setDiet, 1, "Diet")}
        {Option &&
          Option.course &&
          optionElement(Option.course, course, setCourse, 2, "Course")}
        {Option &&
          Option.cuisines &&
          optionElement(Option.cuisines, cuisines, setCuisines, 3, "Cuisines")}
      </div>
